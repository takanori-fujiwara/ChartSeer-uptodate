...
def get_arguments():
    ...
    parser.add_argument('--hidden',
                        type=int,
                        metavar='N',
                        default=params['hidden'])
    parser.add_argument('--dense',
                        type=int,
                        metavar='N',
                        default=params['dense'])
    parser.add_argument('--conv1',
                        type=int,
                        metavar='N',
                        nargs=2,
                        default=params['conv1'])
    parser.add_argument('--conv2',
                        type=int,
                        metavar='N',
                        nargs=2,
                        default=params['conv2'])
    parser.add_argument('--conv3',
                        type=int,
                        metavar='N',
                        nargs=2,
                        default=params['conv3'])
...
def main():
    ...
    model_save = 'trained/vae_H%d_D%d_C%d%d%d_%d%d%d_L%d_B%d.hdf5' % (
        args.hidden, args.dense, args.conv1[0], args.conv2[0], args.conv3[0],
        args.conv1[1], args.conv2[1], args.conv3[1], args.latent, args.batch)
    model = ModelVAE()
    ...
    model.autoencoder.fit(data,
                          ...
                          callbacks=[
                              ...
                              TensorBoard(log_dir='/tmp/visgvae')
                          ],
